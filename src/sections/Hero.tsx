...
export const HeroSection = () => {
  ...
  return (
    <div className="py-32 md:py-48 lg:py-61 relative z-0 overflow-x-clip">
      <div
      ...
      <div className="container">
        ...
        <div className="max-w-lg mx-auto">
          ...
          <p className="mt-4 text-center text-white/60  md:text-base">
            ...
            technical expertise and strong leadership, I turn ideas into
            high-performing solutions. Let&apos;s create something amazing!
          </p>
        </div>

        <div className="flex flex-col md:flex-row justify-center items-center mt-8 gap-4 ">
          <a
            href="https://sandipdulal.medium.com/"
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex  z-10 items-center gap-2 border border-white/15 px-6 h-12 rounded-xl"
          >
            <span className="font-semibold">Explore My Article</span>
          ...
          <button
            ...
            className="inline-flex z-10 items-center gap-2 border border-white bg-white text-gray-900 px-6 h-12 rounded-xl"
          >
            <span>🙌</span>
